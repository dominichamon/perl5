...
#    endif
    ...
    /* Here, there was a problem in an individual category, and 'first_bad'
     * points to whatever in it that is problematic */

    /* The other problems require some sort of name adjustment.  Create a
     * modifiable copy */
